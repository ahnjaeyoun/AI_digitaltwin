...
std::vector<std::string> realtime_output_header() {
    ...
    return {
        ...
        "C_RETURN_velocity_m_s", "V_DIR_PA_velocity_m_s", "V_DIR_PB_velocity_m_s",
        "V_DIR_AT_velocity_m_s", "V_DIR_BT_velocity_m_s",
        "V_RELIEF_velocity_m_s", "C_RELIEF_velocity_m_s", "max_active_velocity_m_s",
...
std::vector<std::string> build_output_row(
    ...
    return {
        ...
        fixed4(map_get_double(result.cell_velocity, "V_DIR_PA")),
        fixed4(map_get_double(result.cell_velocity, "V_DIR_PB")),
        fixed4(map_get_double(result.cell_velocity, "V_DIR_AT")),
        fixed4(map_get_double(result.cell_velocity, "V_DIR_BT")),
